    ...
    public static async Task SeedCities(this AppDbContext appDbContext)
    {
        if (!await appDbContext.Cities.AnyAsync())
        {
            ...
            var egyptianGovernorates = new List<City>{
                 ...
                 new() { Name = "Фергана" },
                 new() { Name = "Кашкадарья" },
                 new() { Name = "Сурхандарья" },
                 new() { Name = "Жиззах" },
                 new() { Name = "Сирдарья" },
                 new() { Name = "Навои" },
                 new() { Name = "Хорезм" },
                new() { Name = "Каракалпакстан" }
            };
        ...
        if (!await appDbContext.Categories.AnyAsync())
        {
            var categories = new List<Category>()
            {
                ...
                */
                ...
                new() { Name = "ПК и Комплектующие", IconUrl = "http://5.42.116.37:9000/bidx-uploads/icons/80f18c73-c50c-4366-bed9-211328a48b12.svg" },
                new() { Name = "Телефоны и планшеты", IconUrl = "https://res.cloudinary.com/dhghzuzbo/image/upload/v1734930651/1ac20496-0ce8-4d3f-861c-7e4f9737decf.svg" },
                new() { Name = "Консоли и игры", IconUrl = "https://res.cloudinary.com/dhghzuzbo/image/upload/v1734930680/c3f22c60-e1bf-4828-bfa1-2e4addd2846d.svg" },
                new() { Name = "Ноутбуки", IconUrl = "https://res.cloudinary.com/dhghzuzbo/image/upload/v1734930651/1ac20496-0ce8-4d3f-861c-7e4f9737decf.svg" },
                new() { Name = "Мониторы", IconUrl = "http://5.42.116.37:9000/bidx-uploads/icons/384284f8-a870-493b-b29e-cc7c4ca73065.svg" }, 
                new() { Name = "Другое", IconUrl = "https://res.cloudinary.com/dhghzuzbo/image/upload/v1734930841/6c9594a6-ae2f-4712-84d9-d7760f3cb500.svg" },
              ...
              /*  new() { Name = "Jewelries", IconUrl = "https://res.cloudinary.com/dhghzuzbo/image/upload/v1734930757/081d69c9-3176-4f17-a63a-02cd8bf5ede1.svg" },
                ...
                new() { Name = "", IconUrl = "https://res.cloudinary.com/dhghzuzbo/image/upload/v1734930902/2567b9d7-33c9-4cf2-95a3-da7f6364d43a.svg" }*/
            };
